...
function setupFeatureUI() {
    ...
    bonusOverlayEl.innerHTML = `<div class="feature-dialog" role="dialog" aria-modal="true" aria-labelledby="bonusTitle"><h2 id="bonusTitle">Pick a Money Vault!</h2><p>One pick awards 2×, 5×, or 10× your triggering bet.</p><div class="bonus-choices"><button type="button">💰</button><button type="button">💰</button><button type="button">💰</button></div></div>`;
